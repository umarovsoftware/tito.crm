...
export function Header({ onMenu }: { onMenu: () => void }) {
  ...
  return (
    <header className="sticky top-0 z-30 flex h-16 min-w-0 items-center gap-2 border-b bg-white/90 px-3 backdrop-blur sm:h-20 sm:gap-3 sm:px-6 lg:px-8 dark:bg-slate-900/90">
      <button className="shrink-0 rounded-xl border p-2.5 lg:hidden" onClick={onMenu}><Menu size={20} /></button>
